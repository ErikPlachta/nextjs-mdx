...
async function run(): Promise<void> {
  try {
    ...
    const dependabotPrefix: string =
      core.getInput("dependabot_prefix") || "chore: "; // Default prefix for dependabot
    ...
    const branchName: string | undefined = context.payload.pull_request
      ? context.payload.pull_request.base.ref
      : context.payload.issue
        ? context.payload.issue.base.ref
        : undefined;
